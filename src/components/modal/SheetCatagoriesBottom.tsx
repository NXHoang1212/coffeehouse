    ...
    <View style={{flexDirection: 'column', gap: 15}}>
      <View style={StyleSheetCategoriesBottom.viebottomheader}>
        <View style={StyleSheetCategoriesBottom.viewcate}>
          <Text style={StyleSheetCategoriesBottom.textcategorytitle}>
            Danh Mục
          </Text>
          <TouchableOpacity>
            <Image
              source={Icon.CANCEL}
              style={StyleSheetCategoriesBottom.iconx}
            />
          </TouchableOpacity>
        </View>
      ...
      <View style={StyleSheetCategoriesBottom.viewcategory}>
          ...
          <View style={StyleSheetCategoriesBottom.viewcategoryitem}>
            <View style={StyleSheetCategoriesBottom.viewimgitem}>
              <Image
                ...
                style={StyleSheetCategoriesBottom.iconcategory}
              />
            </View>
            <Text style={StyleSheetCategoriesBottom.textcategoryfirst}>
              Siêu Deal -{'\n'}39K FREESHIP
            </Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity>
          <View style={StyleSheetCategoriesBottom.viewcategoryitem}>
            ...
            <Text style={StyleSheetCategoriesBottom.textcategorytwo}>
              Cà Phê
            </Text>
          </View>
        </TouchableOpacity>
        ...
        <TouchableOpacity>
          <View style={StyleSheetCategoriesBottom.viewcategoryitem}>
            ...
            <Text style={StyleSheetCategoriesBottom.textcategorytea}>
              Hi-Tea Healthy
            </Text>
          </View>
        </TouchableOpacity>
