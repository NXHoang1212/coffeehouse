...
const SelectModalDataTime = ({ show, onDismiss, enableBackDropDismiss = true }: Props) => {
    ...
    return (
        <Modal visible={open} transparent={true} animationType='fade'>
            <Pressable onPress={enableBackDropDismiss ? onDismiss : undefined} style={StyleSelectModalDataTime.backdrop} />
            <PanGestureHandler onGestureEvent={onGestureEvent} onEnded={onGestureEnd}>
                <Animated.View style={[StyleSelectModalDataTime.container, { bottom: bottomsheet }]}>
                    <StatusBar backgroundColor='rgba(0,0,0,0.5)' />
                    <View style={StyleSelectModalDataTime.header}>
                        <Text style={StyleSelectModalDataTime.textitle}>Thời gian nhận</Text>
                        <TouchableOpacity onPress={onDismiss}>
                            <Image source={Icon.CANCEL} style={StyleSelectModalDataTime.iconcancel} />
                        </TouchableOpacity>
                    </View>
                    <View>
