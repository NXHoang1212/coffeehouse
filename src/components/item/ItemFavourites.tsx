...
const ItemFavourites = ({ item }: PropsItemProduct) => {
    ...
    const renderRightActions = () => {
        return (
            <TouchableOpacity style={StyleItemFavourites.viewiconswipedelete} onPress={() => RemoveFavourites(item._id)}>
                <Image source={Icon.DELETE} style={StyleItemFavourites.iconswipedelete} />
            </TouchableOpacity>
        )
    }
                    ...
                    <Swipeable renderRightActions={renderRightActions}>
                        <View style={StyleItemFavourites.viewProduct}>
                            ...
                            <View style={StyleItemFavourites.viewitemtextproduct}>
                                ...
                                <Text style={StyleItemFavourites.textprice}>{FormatPrice(item.price)}</Text>
                            </View>
                            <TouchableOpacity style={StyleItemFavourites.viewiconplus} onPress={() => handleShowBottomSheet(item)}>
                                <Image source={Icon.PLUS} style={StyleItemFavourites.iconplus} />
                            </TouchableOpacity>
                        </View>
                    </Swipeable>
                </Pressable>
