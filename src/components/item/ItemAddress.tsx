      ...
      <TouchableOpacity
        ...
        <View style={StyleItemGetAddress.viewbody}>
          ...
          <View style={StyleItemGetAddress.viewitemtext}>
            {item.name.length > 0 ? (
              <Text style={StyleItemGetAddress.textName}>{item.name}</Text>
            ) : null}
            <Text style={StyleItemGetAddress.textDescribeAddRess}>
              {item.DescribeAddRess}
            </Text>
            <View style={StyleItemGetAddress.viewuser}>
              <Text style={StyleItemGetAddress.textAddress}>
                {item.username}
              </Text>
