      ...
      <View style={StyleBottomSheetHome.viewbean}>
        ...
        <TouchableOpacity>
          <View style={StyleBottomSheetHome.viewimgbean}>
            <FastImage source={Banner.DISCOUNT40} style={StyleBottomSheetHome.imgbean} />
            <View style={StyleBottomSheetHome.viewtext}>
              <Text style={StyleBottomSheetHome.texttitlebean}>Hi-Tea Kombucha Detox size M chỉ 35k</Text>
              <Text style={StyleBottomSheetHome.textbeanproduct}>The Coffee House</Text>
      ...
      <View style={StyleBottomSheetHome.viewdiscover}>
        ...
        <ScrollView horizontal={true} showsHorizontalScrollIndicator={false} contentContainerStyle={{ flexGrow: 1 }}>
          <View style={StyleBottomSheetHome.viewtabdiscover}>
            <TouchableOpacity style={[StyleBottomSheetHome.tabcontainer, activeTab === "Tab 1" ? StyleBottomSheetHome.activeTab : null,]}
              onPress={() => handleActiveTab("Tab 1")}>
              <Text style={[StyleBottomSheetHome.texttab, activeTab === "Tab 1" ? StyleBottomSheetHome.activeText : null]}>Ưu đãi đặc biệt</Text>
            </TouchableOpacity>
            <TouchableOpacity style={[StyleBottomSheetHome.tabcontainer, activeTab === "Tab 2" ? StyleBottomSheetHome.activeTab : null,]}
              onPress={() => handleActiveTab("Tab 2")}>
              <Text style={[StyleBottomSheetHome.texttab, activeTab === "Tab 2" ? StyleBottomSheetHome.activeText : null]}>Cập nhật từ nhà</Text>
            </TouchableOpacity>
            <TouchableOpacity style={[StyleBottomSheetHome.tabcontainer, activeTab === "Tab 3" ? StyleBottomSheetHome.activeTab : null,]}
              onPress={() => handleActiveTab("Tab 3")}>
              <Text style={[StyleBottomSheetHome.texttab, activeTab === "Tab 3" ? StyleBottomSheetHome.activeText : null]}>#CofeeLover</Text>
            </TouchableOpacity>
          </View>
