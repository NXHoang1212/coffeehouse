      ...
      <View style={styleOther.body}>
        ...
        <View style={styleOther.viewbody}>
          <View style={styleOther.viewutilities}>
            <TouchableOpacity style={styleOther.utilities} onPress={() => navigation.navigate(isLoggedIn ? 'HistoryOrder' : 'AuthStackUser' as any)}>
              <Image style={styleOther.iconutilities} source={infores.HISTORY} />
              <Text style={styleOther.textutilities}>Lịch sử đơn hàng</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styleOther.utilities} onPress={() => navigationDad.navigate('StackHomeNavigate' as any, { screen: 'Rules', params: { link } })}>
              <Image style={styleOther.iconrules} source={infores.RULES} />
              <Text style={styleOther.textutilities}>Điều Khoản</Text>
            </TouchableOpacity>
          </View>
          <TouchableOpacity style={styleOther.music} onPress={() => navigationDad.navigate('StackHomeNavigate' as any, { screen: 'PlayMusic' })}>
        ...
        <View style={styleOther.viewsupport}>
          <TouchableOpacity style={styleOther.support} onPress={() => navigationDad.navigate(isLoggedIn ? 'StackHomeNavigate' : 'AuthStackUser' as any, { screen: 'FeedBackOrder' })}>
          ...
          <TouchableOpacity style={styleOther.support} onPress={() => navigationDad.navigate('StackHomeNavigate' as any, { screen: 'ContactFeedBack', })}>
            <Image style={styleOther.iconsupport} source={infores.STAR} />
        ...
        <View style={styleOther.viewaccount}>
          <TouchableOpacity style={styleOther.account} onPress={() => navigation.navigate(isLoggedIn ? 'Information' : 'AuthStackUser' as any)}>
          ...
          <TouchableOpacity style={styleOther.account} onPress={() => navigationDad.navigate(isLoggedIn ? 'StackHomeNavigate' : 'AuthStackUser' as any, { screen: 'SaveAddress' })}>
