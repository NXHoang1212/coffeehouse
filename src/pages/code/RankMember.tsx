  ...
  return (
    <View style={StyleRankMember.container}>
      ...
      <View style={StyleRankMember.body}>
        <LinearGradient colors={['#fd7e14', '#ff4f0a']} style={StyleRankMember.viewimgbean}>
        ...
        <View style={StyleRankMember.viewtab}>
          <TouchableOpacity onPress={() => handleActiveTab("Tab 1")}>
            <View style={StyleRankMember.viewtabitem}>
              <Text style={activeTab === "Tab 1" ? StyleRankMember.texttabactive : StyleRankMember.texttab}>Mới</Text>
              <View style={activeTab === "Tab 1" ? StyleRankMember.viewtablineactive : StyleRankMember.viewtabline} />
            </View>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => handleActiveTab("Tab 2")}>
            <View style={StyleRankMember.viewtabitem}>
              <Text style={activeTab === "Tab 2" ? StyleRankMember.texttabactive : StyleRankMember.texttab}>Đồng</Text>
              <View style={activeTab === "Tab 2" ? StyleRankMember.viewtablineactive : StyleRankMember.viewtabline} />
            </View>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => handleActiveTab("Tab 3")}>
            <View style={StyleRankMember.viewtabitem}>
              <Text style={activeTab === "Tab 3" ? StyleRankMember.texttabactive : StyleRankMember.texttab}>Bạc</Text>
              <View style={activeTab === "Tab 3" ? StyleRankMember.viewtablineactive : StyleRankMember.viewtabline} />
            </View>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => handleActiveTab("Tab 4")}>
            <View style={StyleRankMember.viewtabitem}>
              <Text style={activeTab === "Tab 4" ? StyleRankMember.texttabactive : StyleRankMember.texttab}>Vàng</Text>
              <View style={activeTab === "Tab 4" ? StyleRankMember.viewtablineactive : StyleRankMember.viewtabline} />
            </View>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => handleActiveTab("Tab 5")}>
            <View style={StyleRankMember.viewtabdiamon}>
              <Text style={activeTab === "Tab 5" ? StyleRankMember.texttabactive : StyleRankMember.texttab}>Kim cương</Text>
              <View style={activeTab === "Tab 5" ? StyleRankMember.viewtablineactive : StyleRankMember.viewtabline} />
            </View>
          </TouchableOpacity>
        </View>
        {activeTab === "Tab 1" ? (
          <View style={StyleRankMember.viewitem}></View>
        ) : activeTab === "Tab 2" ? (
